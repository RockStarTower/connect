...
<div class="lSide">
	...
	<div class="pickTask">
		<div style="margin: 10px; margin: 10px; padding: 24px; padding-left: 0px; margin-top: 50px;">
			<div style="color: white; opacity: .7" id="time" >
			Hours
			...
			<div id="controls">
			    <button class="btn btn-default timer" id="start_pause_resume" style="width: 70px !important; margin-bottom: 3px; margin-top: 8px; padding: 3px;">Start</button>
			    <button class="btn btn-default timer" id="reset" style="width: 70px !important;padding: 3px;">Reset</button>
			</div>
		</div>
<!--
