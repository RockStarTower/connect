...
if ($wireframe == 20){
	...
	$call_to_action1 = $_POST['content']['page1']['slider_content'];
	$call_to_action2 = $_POST['content']['page2']['slider_content'];
	$call_to_action3 = $_POST['content']['page3']['slider_content'];
...
switch($wireframe) {
	...
	case 23:
		...
		break;
	case 24:
		$_POST['content']['homepage']['content'] = '<div class="et_builder clearfix"><div class="et_lb_module et_lb_text_block et_lb_first">[widgetkit id=ab_slider_id]<h1>'.$hp_h1.'</h1></div> <!-- end .et_lb_text_block --><div class="et_lb_module et_lb_column et_lb_3_4 et_lb_first"><div class="et_lb_module et_lb_text_block"><div class="left"><p><img alt="'.$title1.'" src="../wp-content/uploads/image1.jpg"></p><h3>'.$title1.'</h3><p class="content">'.$content1.'</p></div><div class="center"><p><img alt="'.$title2.'" src="../wp-content/uploads/image2.jpg"></p><h3>'.$title2.'</h3><p class="content">'.$content2.'</p></div><div class="right"><p><img alt="'.$title3.'" src="../wp-content/uploads/image3.jpg"></p><h3>'.$title3.'</h3><p class="content">'.$content3.'</p></div><div><p><img class="homepage" alt="'.$title4.'" src="../wp-content/uploads/image4.jpg"></p><h3>'.$title4.'</h3><p>'.$content4.'</p></div></div> <!-- end .et_lb_text_block --></div> <!-- end .et_lb_column_et_lb_3_4 --><div class="et_lb_module et_lb_column et_lb_1_4"><div class="et_lb_module et_lb_widget_area">[do_widget "Recent Posts"]</div> <!-- end .et_lb_widget_area --></div> <!-- end .et_lb_column_et_lb_1_4 --></div>';
		break;
	case 25:
		$_POST['content']['homepage']['content'] = array($hp_h1, '<div class="box1"><h2>'.$title1.'</h2><img alt="'.$title1.'" src="../wp-content/uploads/image1.jpg"><p>'.$content1.'</p></div><div class="box2"><h2>'.$title2.'</h2><img alt="'.$title2.'" src="../wp-content/uploads/image2.jpg"><p>'.$content2.'</p></div><div class="box3"><h2>'.$title3.'</h2><img alt="'.$title3.'" src="../wp-content/uploads/image3.jpg"><p>'.$content3.'</p></div>');
		break;
