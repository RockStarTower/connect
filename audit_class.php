...
class audit {
    ...
    public function print_robots() {
        if ($this->robots) {
            ...
            $this->error['robots'] = "<p>There was no robots.txt file found for $this->domain.";
        }
    }
    ...
    public function print_sitemap() {
        if ($this->sitemap) {
            ...
            foreach ($urls as $key => $val) {
                echo '<ul>';
                if ($val['tag'] == 'LOC') {
                    echo '<li><a href="audit.php?domain=' . $val['value'] . '">' . $val['value'] . '</a></li>';
                }
                echo '</ul>';
            }
        } else {
            $this->error['sitemap'] = "<p>There was no sitemap.xml file found for $this->domain.";
        }
    }
